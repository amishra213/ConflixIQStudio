  ...
  const customBasicFields = (
    <div className="space-y-3">
      <div>
        ...
        />
        <p className="text-xs text-gray-400 mt-1">Type of evaluator (e.g., javascript, jq)</p>
      </div>
      <div>
        ...
        />
        <p className="text-xs text-gray-400 mt-1">The expression to be evaluated inline</p>
      </div>
    </div>
  );

...
export interface JsonJqTransformStringTaskConfig {
      ...
      <DialogContent className="max-w-2xl bg-[#1a1f2e] border-[#2a3142] text-white">
        <DialogHeader>
          <DialogTitle className="text-2xl font-semibold">
            Create JSON JQ Transform String System Task
          </DialogTitle>
        </DialogHeader>
            ...
            <div className="space-y-3">
              <div>
                ...
                <Input
                  ...
                  placeholder="JSON JQ Transform String task name"
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="e.g., jq_transform_string_1"
                  className="mt-1 bg-[#1a1f2e] text-white border-[#2a3142]"
                />
              </div>
              <div>

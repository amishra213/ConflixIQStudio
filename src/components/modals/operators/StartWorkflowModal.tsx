  ...
  const customBasicFields = (
    <div className="space-y-4">
      ...
      <div>
        ...
        />
        <p className="text-xs text-gray-400 mt-1">Name of the workflow to start</p>
      </div>

      {/* Workflow Version */}
      <div>
        <Label className="text-white">Workflow Version</Label>
        <Input
          type="number"
      ...
      {/* Correlation ID */}
      <div>
        <Label className="text-white">Correlation ID</Label>
        <Input
      ...
      {/* Workflow Input */}
      <div>
        <Label className="text-white">Workflow Input</Label>
        <Textarea
          value={workflowInput}
      ...
      {/* Task to Domain */}
      <div>
        <Label className="text-white">Task to Domain (Optional)</Label>
        <Textarea
          value={taskToDomain}
          onChange={(e) => setTaskToDomain(e.target.value)}
          placeholder='{\n  "taskName": "domainName"\n}'
          className="mt-1 bg-[#1a1f2e] text-white border-[#2a3142] font-mono text-sm min-h-[80px]"
        />
        <p className="text-xs text-gray-400 mt-1">
      ...
      {/* Workflow Definition */}
      <div>
        <Label className="text-white">Workflow Definition (Optional)</Label>
        <Textarea
          value={workflowDef}

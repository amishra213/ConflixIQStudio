...
// Define LambdaTaskConfiguration type if not imported from elsewhere
...
{DO_WHILE_EXAMPLE}
      ...
      {isConfiguringLambdaTask && (
        <LambdaTaskConfigModal
          ...
          initialConfig={
            currentTaskIndex >= 0 && loopTasks[currentTaskIndex]?.taskType === 'LAMBDA'
              ? (loopTasks[currentTaskIndex] as LambdaTaskConfiguration)
              : undefined
          }
          sequenceNo={currentTaskIndex >= 0 ? currentTaskIndex + 1 : loopTasks.length + 1}
        />

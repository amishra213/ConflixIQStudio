...
interface SignalOrScheduledWaitTaskModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSave: (config: SignalOrScheduledWaitTaskConfig) => void;
  initialConfig?: SignalOrScheduledWaitTaskConfig | null;
}
...
export function SignalOrScheduledWaitTaskModal({
  open,
  onOpenChange,
  onSave,
  initialConfig,
}: SignalOrScheduledWaitTaskModalProps) {

...
export const ConditionForm: React.FC<ConditionFormProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-6 gap-3 items-end p-3 bg-[#0f1419] border border-[#2a3142] rounded-md">
      <div className="md:col-span-2">
        ...
        <Input
          ...
          className="mt-1 h-9 bg-[#1a1f2e] text-white border-[#2a3142]"
        />
      </div>
      <div>
        <Label className="text-white text-xs">Condition Type</Label>
        <Select
          value={condition.conditionType}
          onValueChange={(value: ConditionType) => handleSelectChange('conditionType', value)}
        >
          <SelectTrigger className="mt-1 h-9 bg-[#1a1f2e] text-white border-[#2a3142]">
      ...
      {showDurationFields && (
        <>
          ...
          <div>
            <Label className="text-white text-xs">UOM</Label>
            <Select
              value={condition.uom || ''}
